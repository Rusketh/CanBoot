...
| Runtime | picolibc 1.8.11, preemptive-capable thread scheduler (rt/sched) behind the pthread surface, mmap-backed heap (largest usable boot_info region, serialised behind the allocator guard) |
