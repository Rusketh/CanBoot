...
Standard base64 codec, most often paired with [`crypto.*`](crypto.md)
...
- [`hex`](hex.md) — the other binary-to-text codec
- [`crypto`](crypto.md) — produces digests you'll often base64-encode
