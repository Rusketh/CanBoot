# file — single-disk root-directory convenience
...
non-FAT32 filesystems use [`fs.*`](fs.md) instead.
...
- [`fs`](fs.md) — filesystem-aware, multi-partition file ops
- [`disk`](disk.md) — raw block device access
